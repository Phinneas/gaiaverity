...
```napkin
Create a flowchart:
Plant lettuce every 2 weeks -> Harvest mature plants -> Start new seeds -> Replace spring peas with summer beans -> Follow with fall broccoli -> Three harvests from one plot
```

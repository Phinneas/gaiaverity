...
```napkin
Create a flowchart:
Pest Confusion (aromatic plants mask tomato scent) -> Nutrient Cycling (deep roots mine minerals) -> Beneficial Insect Attraction (predators arrive) -> Allelopathy (chemical interactions) -> Healthier Tomato Plants
```
...
Photo by [Pham Hien Triet](https://unsplash.com/@chhientriet) / [Unsplash](https://unsplash.com/?utm_source=ghost&utm_medium=referral&utm_campaign=api-credit)

...
```napkin
Create a flowchart:
Identify holly variety -> Determine climate zone -> Choose pruning window (late winter for most) -> Apply one-third rule -> Make proper cuts -> Water and care post-pruning
```

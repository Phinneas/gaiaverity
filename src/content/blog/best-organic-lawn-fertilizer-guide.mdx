...
```napkin
Create a flowchart:
Week 1-2: No visible change; microbes colonize -> Week 2-3: Subtle darkening; root growth -> Week 3-4: Noticeable color deepening; density increases -> Week 5-8: Peak performance; deep green -> Week 9-12: Sustained color; weed reduction; deeper roots
```
...
**Actual cause:** Unlikely to be nutrient burn (organic rarely burns
...
```napkin
Create a flowchart:
Remove visible mushrooms -> Adjust irrigation to 1 inch/week -> Reduce thatch by dethatching -> Aerate compacted areas -> Limit shade by pruning branches -> Overseed thin spots -> Healthy lawn resistant to fungi
```

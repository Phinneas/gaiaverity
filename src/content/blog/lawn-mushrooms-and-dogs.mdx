...
```napkin
Create a flowchart:
Dog eats mushroom -> Remove pieces from mouth -> Photograph mushroom and location -> Watch for symptoms -> Collect sample if safe -> Call vet or poison control -> Follow vet instructions -> Monitor dog
```

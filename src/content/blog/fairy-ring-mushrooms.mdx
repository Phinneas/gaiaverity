...
```napkin
Create a flowchart:
Spore lands in soil -> Mycelium spreads radially -> Mycelium decomposes organic matter -> Nutrients released at ring edge -> Mushrooms fruit at ring edge -> Ring expands outward
```

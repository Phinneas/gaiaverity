...
```napkin
Create a mind map:
- Climate-Resilient Yard
  - Modified Meadow
    - Solves: Off-season pollinator collapse
    - Key plants: Evergreen grasses, winter-blooming shrubs
  - Orchard Understory Carpet
    - Solves: Food insecurity, pollinator timing
    - Key plants: Cosmos, Yarrow, Borage
  - Edible-Weed Understory
    - Solves: Food access, nutritional diversity
    - Key plants: Chickweed, Purslane, Miner's Lettuce
  - Sound and Scent Spiral
    - Solves: Heat island effect, climate anxiety
    - Key plants: Mountain Mint, Anise Hyssop, grasses
  - Nighttime Moon Meadow
    - Solves: Pollinator diversity collapse
    - Key plants: Evening Primrose, White Campion, Moonflower
```

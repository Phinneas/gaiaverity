...
```napkin
Create a flowchart:
Identify mushroom features (cap, gills, stem, spore print) -> Compare against known toxic species (Chlorophyllum, Amanita, Gyromitra) -> If uncertain, take photos and spore print -> Send to county extension or certified mycologist -> Receive definitive identification
```

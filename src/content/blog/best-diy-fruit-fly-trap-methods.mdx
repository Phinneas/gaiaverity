...
```napkin
Create a flowchart:
Fruit flies appear -> Female lays up to 500 eggs -> Eggs hatch within 24 hours -> Exponential population growth -> Attracted by fermentation gases from overripe fruit -> Infestation spreads
```
